...
Möchten Sie {{< param BITS >}} herunterladen und anpassen, was wir sehr empfehlen, finden Sie auf unserer [Download-Seite](https://github.com/BITS-Training/BITS-hugo/releases) bei Github zwei ZIP-Archive - . Dieses enthält alle notwendigen Dateien für den Betrieb. Ebenfalls enthalten ist Beschreibung (README.md) zur Installation und zur Anpassung an Ihre lokalen Verhältnisse (z.B. Änderung der Ansprechpersonen,...). Es kann insbesondere erforderlich sein, {{< param BITS >}} auf Ihre spezifischen Anforderungen anzupassen, die sich aus einschlägigen Gesetzen, Dienstanweisungen oder -vereinbarungen ergeben. Dies gilt insbesondere für die Kapitel "E-Mail" und "Vertrauliche Daten". Es ist aber auch sinnvoll, wie in der README.md im ZIP-Archiv geschildert, das Header-Bild auszutauschen, um {{< param BITS >}} besser in Ihr Intranet zu integrieren.

{{< param BITS >}} finden Sie auch als öffentliches git-Repository unter [https://github.com/BITS-Training](https://github.com/BITS-Training). Hier stehen Informationen zur Verfügung, wie Sie über git Versionsänderungen nachvollziehen und eine eigene Version erstellen können.
