...
- Wird ein Zertifikatsfehler angezeigt, ist das Zertifikat abgelaufen oder ist es auf eine Ihnen unbekannte Stelle als Seiteninhaber ausgestellt, sollten Sie der Seite nicht vertrauen.
  {{% /notice %}}
